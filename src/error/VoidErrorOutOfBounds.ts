...
export class VoidErrorOutOfBounds extends VoidError {
	 ...
	 */
	public constructor(manner: 'index', base: VALUE.CollectionIndexed, index: bigint, accessor: AST.Index | AST.Expression);
	/**
	 ...
	 */
	public constructor(manner: 'key', base: VALUE.CollectionKeyed, key: bigint, accessor: AST.Key | AST.Expression);
	/**
	 ...
	 */
	public constructor(manner: 'key', base: VALUE.Map, key: VALUE.Value, accessor: AST.Expression);
	public constructor(
		manner:       'index' | 'key',
		base:         VALUE.CollectionIndexed | VALUE.CollectionKeyed | VALUE.Map,
		index_or_key: bigint | VALUE.Value,
		accessor:     AST.Index | AST.Key | AST.Expression,
	) {
		super(
