...
export class VoidErrorOutOfBounds extends VoidError {
	 ...
	 */
	public constructor(manner: 'index', base: VALUE.CollectionIndexed, index: bigint, accessor: AST.ASTNodeIndex | AST.ASTNodeExpression);
	/**
	 ...
	 */
	public constructor(manner: 'key', base: VALUE.CollectionKeyed, key: bigint, accessor: AST.ASTNodeKey | AST.ASTNodeExpression);
	/**
	 ...
	 */
	public constructor(manner: 'key', base: VALUE.Map, key: VALUE.Value, accessor: AST.ASTNodeExpression);
	public constructor(
		manner:       'index' | 'key',
