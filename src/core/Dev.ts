...
export class Dev {
	 ...
	 * they are *not* {@link CplConfig|language feature options} for production
	 ...
	 * Released features may have an optional language feature option defined in {@link CplConfig}.
	 */
