...
export default abstract class Token implements Serializable {
	 ...
	 */
	protected advance(lexer:Lexer, n: bigint = 1n): void {
		this._cargo += lexer.advance(n).map((char) => char.source).join('')
	}
