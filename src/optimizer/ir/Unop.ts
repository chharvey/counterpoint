...
export class Unop extends Value {
	...
	public override codegen(cg: Builder): binaryen.ExpressionRef {
		...
		switch (this.operator) {
			...
			case OpCode.LIST_COUNT: { return cg.newValue(cg.vm.Vect.newNat(cg.module.i64.extend_u(cg.module.call('List.count', [code], binaryen.i32)))); }
			case OpCode.DICT_COUNT: { return cg.newValue(cg.vm.Vect.newNat(cg.module.i64.extend_u(cg.module.call('Dict.count', [code], binaryen.i32)))); }
			case OpCode.SET_COUNT:  { return cg.newValue(cg.vm.Vect.newNat(cg.module.i64.extend_u(cg.module.call('Map.count',  [code], binaryen.i32)))); }
			case OpCode.MAP_COUNT:  { return cg.newValue(cg.vm.Vect.newNat(cg.module.i64.extend_u(cg.module.call('Map.count',  [code], binaryen.i32)))); }
		}
	}
