...
/**
 * Directly execute Counterpoint source code.
 * @param sourcecode - the Counterpoint source text
 * @return the output text
 */
export function interpret(sourcecode: string, config: CplConfig = CONFIG_DEFAULT): void {
	return new Program(sourcecode, config).interpret();
}
