...
export class ASTNodeOperationBinaryLogical extends ASTNodeOperationBinary {
	...
	protected override type_do_do(t0: TYPE.Type, t1: TYPE.Type, _int_coercion: boolean): TYPE.Type {
		const falsytypes: TYPE.Type = TYPE.Type.VOID.union(TYPE.Type.NULL).union(OBJ.SolidBoolean.FALSETYPE);
		return (this.operator === Operator.AND)
			...
			: (t0.isSubtypeOf(falsytypes))
				? t1
				: (TYPE.Type.VOID.isSubtypeOf(t0) || TYPE.Type.NULL.isSubtypeOf(t0) || OBJ.SolidBoolean.FALSETYPE.isSubtypeOf(t0))
