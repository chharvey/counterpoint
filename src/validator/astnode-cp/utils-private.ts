...
export function bothNumeric(v0: OBJ.Value, v1: OBJ.Value): boolean;
export function bothNumeric(arg0: TYPE.Type | OBJ.Value, arg1: TYPE.Type | OBJ.Value): boolean {
...
export function bothInts(v0: OBJ.Value, v1: OBJ.Value): boolean;
export function bothInts(arg0: TYPE.Type | OBJ.Value, arg1: TYPE.Type | OBJ.Value): boolean {
	return (arg0 instanceof TYPE.Type && arg1 instanceof TYPE.Type)
...
export function bothFloats(v0: OBJ.Value, v1: OBJ.Value): boolean;
export function bothFloats(arg0: TYPE.Type | OBJ.Value, arg1: TYPE.Type | OBJ.Value): boolean {
	return (arg0 instanceof TYPE.Type && arg1 instanceof TYPE.Type)
...
export function eitherFloats(v0: OBJ.Value, v1: OBJ.Value): boolean;
export function eitherFloats(arg0: TYPE.Type | OBJ.Value, arg1: TYPE.Type | OBJ.Value): boolean {
	return (arg0 instanceof TYPE.Type && arg1 instanceof TYPE.Type)
...
export function neitherFloats(v0: OBJ.Value, v1: OBJ.Value): boolean;
export function neitherFloats(arg0: TYPE.Type | OBJ.Value, arg1: TYPE.Type | OBJ.Value): boolean {
	// @ts-expect-error --- both args are either both `TYPE.Type`s or both `OBJ.Value`s
	return !eitherFloats(arg0, arg1);
}

export function oneFloats(t0: TYPE.Type, t1: TYPE.Type): boolean;
export function oneFloats(v0: OBJ.Value, v1: OBJ.Value): boolean;
export function oneFloats(arg0: TYPE.Type | OBJ.Value, arg1: TYPE.Type | OBJ.Value): boolean {
	// @ts-expect-error --- both args are either both `TYPE.Type`s or both `OBJ.Value`s
