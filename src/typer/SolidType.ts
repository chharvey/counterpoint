...
export abstract class SolidType {
	...
	/** The Null Type. */                                            static get NULL():    SolidTypeUnit<SolidNull> { return SolidNull.NULLTYPE; }
	...
	public defaultBinValue(mod: binaryen.Module): binaryen.ExpressionRef {
		return (
			...
			(this instanceof SolidTypeUnion)  ? Builder.createBinEither(mod, 0n, [this.left.defaultBinValue(mod), this.right.defaultBinValue(mod)]) :
