...
export function updateAccessedStaticType(entry: TypeEntry, access_kind: ValidAccessOperator, is_nullish: boolean, access: AST.ASTNodeTypeAccess | AST.ASTNodeAccess): Type {
	switch (true) {
